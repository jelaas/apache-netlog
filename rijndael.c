...
static void
rijndael_encrypt (RIJNDAEL_context *ctx, byte *b, const byte *a)
{
    do_encrypt (ctx, b, a);
...
/* Bulk encryption of complete blocks in CFB mode.  Caller needs to
   ...
   cipher.c. */
void
rijndael_cfb_enc (RIJNDAEL_context *ctx, unsigned char *iv, 
...
/* Bulk decryption of complete blocks in CFB mode.  Caller needs to
   ...
   cipher.c. */
void
rijndael_cfb_dec (RIJNDAEL_context *ctx, unsigned char *iv, 
                  void *outbuf_arg, const void *inbuf_arg,
                  unsigned int nblocks)
{
  unsigned char *outbuf = outbuf_arg;
